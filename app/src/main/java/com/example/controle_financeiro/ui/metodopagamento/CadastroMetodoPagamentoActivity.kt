...
class CadastroMetodoPagamentoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cadastro_metodo_pagamento)
        ...
        btnSalvarMetodo.setOnClickListener {
            ...
            val metodo = hashMapOf("nomeMetodo" to nome)
